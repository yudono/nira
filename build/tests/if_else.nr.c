...
Value nr_check(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
...
int main(int argc, char** argv) {
  ...
  nr_v_check = val_func(nr_check);
val_func(nr_check);
val_nil();
nr_check(val_nil(), val_int(15), val_nil(), val_nil(), val_nil(), val_nil());
nr_check(val_nil(), val_int(5), val_nil(), val_nil(), val_nil(), val_nil());
  return 0; 
}
