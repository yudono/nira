...
Value nr_make_counter(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  return ({ Value _o = val_obj(); set_field(_o, "increment", val_func(nr_anonymous)); set_field(_o, "get", val_func(nr_anonymous)); set_field(_o, "reset", val_func(nr_anonymous)); _o; });
  return val_nil();
}
Value nr_make_adder(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_n = _v0; if(nr_v_n.type == VAL_NIL) { }
  return val_func(nr_anonymous);
  return val_nil();
}
Value nr_make_multiplier(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_factor = _v0; if(nr_v_factor.type == VAL_NIL) { }
  return val_func(nr_anonymous);
  return val_nil();
}
Value nr_compose(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_f = _v0; if(nr_v_f.type == VAL_NIL) { }
  Value nr_v_g = _v1; if(nr_v_g.type == VAL_NIL) { }
  return val_func(nr_anonymous);
  return val_nil();
}
Value nr_createAnimal(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_sound = _v1; if(nr_v_sound.type == VAL_NIL) { }
  return ({ Value _o = val_obj(); set_field(_o, "name", nr_v_name); set_field(_o, "sound", nr_v_sound); set_field(_o, "speak", val_func(nr_anonymous)); set_field(_o, "rename", val_func(nr_anonymous)); _o; });
  return val_nil();
}
Value nr_apply_all(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_fns = _v0; if(nr_v_fns.type == VAL_NIL) { }
  Value nr_v_value = _v1; if(nr_v_value.type == VAL_NIL) { }
  ...
  nr_v_result = ({ Value _f = nr_v_f; if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), nr_v_result, val_nil(), val_nil(), val_nil(), val_nil()); } else { val_nil(); } });
    }
  } }
;
  return nr_v_result;
...
({ nr_rt_print(val_nil(), nr_rt_add(val_str("initial: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_counter, "get"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ Value _f = get_field(nr_v_counter, "increment"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } });
({ Value _f = get_field(nr_v_counter, "increment"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } });
({ Value _f = get_field(nr_v_counter, "increment"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("after 3 increments: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_counter, "get"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ Value _f = get_field(nr_v_counter, "reset"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("after reset: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_counter, "get"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
...
({ Value _f = get_field(nr_v_c1, "increment"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } });
({ Value _f = get_field(nr_v_c2, "increment"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } });
({ Value _f = get_field(nr_v_c2, "increment"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("c1: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_c1, "get"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("c2: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_c2, "get"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
