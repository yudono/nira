...
Value nr_anon_3(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_make_adder(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_anon_4(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_make_multiplier(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_anon_5(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_compose(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_anon_6(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_createAnimal(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_anon_7(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_anon_8(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_apply_all(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
...
Value nr_v_anon_2;
Value nr_v_anon_3;
Value nr_v_make_adder;
Value nr_v_n;
Value nr_v_anon_4;
Value nr_v_x;
Value nr_v_make_multiplier;
Value nr_v_factor;
Value nr_v_anon_5;
Value nr_v_compose;
Value nr_v_f;
Value nr_v_g;
Value nr_v_anon_6;
Value nr_v_createAnimal;
Value nr_v_name;
Value nr_v_sound;
Value nr_v_anon_7;
Value nr_v_anon_8;
Value nr_v_new_name;
Value nr_v_apply_all;
Value nr_v_fns;
Value nr_v_value;
Value nr_v_result;
Value nr_v_print;
...
Value nr_make_counter(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  return ({ Value _o = val_obj(); set_field(_o, "increment", val_func(nr_anon_1)); set_field(_o, "get", val_func(nr_anon_2)); set_field(_o, "reset", val_func(nr_anon_3)); _o; });
  return val_nil();
}
Value nr_anon_1(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
...
Value nr_make_adder(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  return val_func(nr_anon_4);
  return val_nil();
}
Value nr_anon_4(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_x;
  nr_v_x = _v0; if(nr_v_x.type == VAL_NIL) { }
  return nr_rt_add(nr_v_x, nr_v_n);
  return val_nil();
}
Value nr_make_multiplier(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_factor;
  nr_v_factor = _v0; if(nr_v_factor.type == VAL_NIL) { }
  return val_func(nr_anon_5);
  return val_nil();
}
Value nr_anon_5(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_x;
  nr_v_x = _v0; if(nr_v_x.type == VAL_NIL) { }
  return val_int(((nr_v_x).data.i * (nr_v_factor).data.i));
  return val_nil();
}
Value nr_compose(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_f;
  nr_v_f = _v0; if(nr_v_f.type == VAL_NIL) { }
  Value nr_v_g;
  nr_v_g = _v1; if(nr_v_g.type == VAL_NIL) { }
  return val_func(nr_anon_6);
  return val_nil();
}
Value nr_anon_6(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_x;
  nr_v_x = _v0; if(nr_v_x.type == VAL_NIL) { }
  return ({ Value _f = nr_v_f; _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), ({ Value _f = nr_v_g; _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), nr_v_x, val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
  return val_nil();
}
Value nr_createAnimal(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_name;
  nr_v_name = _v0; if(nr_v_name.type == VAL_NIL) { }
  Value nr_v_sound;
  nr_v_sound = _v1; if(nr_v_sound.type == VAL_NIL) { }
  return ({ Value _o = val_obj(); set_field(_o, "name", nr_v_name); set_field(_o, "sound", nr_v_sound); set_field(_o, "speak", val_func(nr_anon_7)); set_field(_o, "rename", val_func(nr_anon_8)); _o; });
  return val_nil();
}
Value nr_anon_7(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  return nr_rt_add(nr_rt_add(nr_rt_at(val_nil(), self, val_str("name"), val_nil(), val_nil(), val_nil()), val_str(" says ")), nr_rt_at(val_nil(), self, val_str("sound"), val_nil(), val_nil(), val_nil()));
  return val_nil();
}
Value nr_anon_8(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_new_name;
  nr_v_new_name = _v0; if(nr_v_new_name.type == VAL_NIL) { }
  nr_rt_set_at(val_nil(), self, val_str("name"), nr_v_new_name, val_nil(), val_nil());
  return self;
  return val_nil();
}
Value nr_apply_all(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_fns;
  nr_v_fns = _v0; if(nr_v_fns.type == VAL_NIL) { }
  Value nr_v_value;
  nr_v_value = _v1; if(nr_v_value.type == VAL_NIL) { }
  nr_v_result = nr_v_value;
  { Value _iter = nr_v_fns; if (_iter.type == VAL_ARR) {
    for (int _i = 0; _i < _iter.data.arr->count; _i++) {
      nr_v_f = *_iter.data.arr->elements[_i];
  nr_v_result = ({ Value _f = nr_v_f; _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), nr_v_result, val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
    }
  } }
;
  return nr_v_result;
...
int main(int argc, char** argv) {
  ...
  nr_v_anon_2 = val_nil();
  nr_v_anon_3 = val_nil();
  nr_v_make_adder = val_nil();
  nr_v_n = val_nil();
  nr_v_anon_4 = val_nil();
  nr_v_x = val_nil();
  nr_v_make_multiplier = val_nil();
  nr_v_factor = val_nil();
  nr_v_anon_5 = val_nil();
  nr_v_compose = val_nil();
  nr_v_f = val_nil();
  nr_v_g = val_nil();
  nr_v_anon_6 = val_nil();
  nr_v_createAnimal = val_nil();
  nr_v_name = val_nil();
  nr_v_sound = val_nil();
  nr_v_anon_7 = val_nil();
  nr_v_anon_8 = val_nil();
  nr_v_new_name = val_nil();
  nr_v_apply_all = val_nil();
  nr_v_fns = val_nil();
  nr_v_value = val_nil();
  nr_v_result = val_nil();
  nr_v_print = val_nil();
  nr_v_counter = val_nil();
  ...
  nr_v_make_counter = val_func(nr_make_counter);
  nr_v_anon_1 = val_func(nr_anon_1);
  nr_v_anon_2 = val_func(nr_anon_2);
  nr_v_anon_3 = val_func(nr_anon_3);
  nr_v_make_adder = val_func(nr_make_adder);
  nr_v_anon_4 = val_func(nr_anon_4);
  nr_v_make_multiplier = val_func(nr_make_multiplier);
  nr_v_anon_5 = val_func(nr_anon_5);
  nr_v_compose = val_func(nr_compose);
  nr_v_anon_6 = val_func(nr_anon_6);
  nr_v_createAnimal = val_func(nr_createAnimal);
  nr_v_anon_7 = val_func(nr_anon_7);
  nr_v_anon_8 = val_func(nr_anon_8);
  nr_v_apply_all = val_func(nr_apply_all);
val_func(nr_make_counter);
val_func(nr_make_adder);
val_func(nr_make_multiplier);
val_func(nr_compose);
val_func(nr_createAnimal);
val_func(nr_apply_all);
val_nil();
({ nr_rt_print(val_nil(), val_str("=== STRESS: Closures & Scope ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Creating counter..."), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_counter = nr_make_counter(val_nil(), val_int(0), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str("Counter created."), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("initial: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_counter, "get"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ Value _f = get_field(nr_v_counter, "increment"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
({ Value _f = get_field(nr_v_counter, "increment"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
({ Value _f = get_field(nr_v_counter, "increment"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("after 3 increments: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_counter, "get"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ Value _f = get_field(nr_v_counter, "reset"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("after reset: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_counter, "get"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_counter, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_c1 = nr_make_counter(val_nil(), val_int(10), val_nil(), val_nil(), val_nil(), val_nil());
  nr_v_c2 = nr_make_counter(val_nil(), val_int(100), val_nil(), val_nil(), val_nil(), val_nil());
({ Value _f = get_field(nr_v_c1, "increment"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
({ Value _f = get_field(nr_v_c2, "increment"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
({ Value _f = get_field(nr_v_c2, "increment"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("c1: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_c1, "get"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("c2: "), nr_rt_to_string(val_nil(), ({ Value _f = get_field(nr_v_c2, "get"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_c2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("=== Closures & Scope stress PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
