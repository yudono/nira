...
Value nr_app(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr__app_get(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr__app_post(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr__app_put(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr__app_delete(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr__app_listen(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);

Value nr_v__routes;
Value nr_v_app;
Value nr_v__app_get;
Value nr_v__app_post;
Value nr_v__app_put;
Value nr_v__app_delete;
Value nr_v__app_listen;
Value nr_v_path;
Value nr_v_handler;
Value nr_v_port;
Value nr_v___builtin_http_serve;
Value nr_v_http;
Value nr_v_print;
Value nr_v_start;
Value nr_v_end;
...
Value nr_app(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  return ({ Value _o = val_obj(); set_field(_o, "routes", nr_v__routes); set_field(_o, "get", val_func(nr__app_get)); set_field(_o, "post", val_func(nr__app_post)); set_field(_o, "put", val_func(nr__app_put)); set_field(_o, "delete", val_func(nr__app_delete)); set_field(_o, "listen", val_func(nr__app_listen)); _o; });
  return val_nil();
}
Value nr__app_get(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  Value nr_v_handler;
  nr_v_handler = _v1; if(nr_v_handler.type == VAL_NIL) { }
({ nr_rt_push(val_nil(), nr_v__routes, ({ Value _o = val_obj(); set_field(_o, "method", val_str("GET")); set_field(_o, "path", nr_v_path); set_field(_o, "handler", nr_v_handler); _o; }), val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
Value nr__app_post(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  Value nr_v_handler;
  nr_v_handler = _v1; if(nr_v_handler.type == VAL_NIL) { }
({ nr_rt_push(val_nil(), nr_v__routes, ({ Value _o = val_obj(); set_field(_o, "method", val_str("POST")); set_field(_o, "path", nr_v_path); set_field(_o, "handler", nr_v_handler); _o; }), val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
Value nr__app_put(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  Value nr_v_handler;
  nr_v_handler = _v1; if(nr_v_handler.type == VAL_NIL) { }
({ nr_rt_push(val_nil(), nr_v__routes, ({ Value _o = val_obj(); set_field(_o, "method", val_str("PUT")); set_field(_o, "path", nr_v_path); set_field(_o, "handler", nr_v_handler); _o; }), val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
Value nr__app_delete(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  Value nr_v_handler;
  nr_v_handler = _v1; if(nr_v_handler.type == VAL_NIL) { }
({ nr_rt_push(val_nil(), nr_v__routes, ({ Value _o = val_obj(); set_field(_o, "method", val_str("DELETE")); set_field(_o, "path", nr_v_path); set_field(_o, "handler", nr_v_handler); _o; }), val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
Value nr__app_listen(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_port;
  nr_v_port = _v0; if(nr_v_port.type == VAL_NIL) { }
nr_rt_http_serve(val_nil(), nr_v_port, nr_v__routes, val_nil(), val_nil(), val_nil());
  return val_nil();
}
int main(int argc, char** argv) {
  ...
  nr_v_app = val_nil();
  nr_v__app_get = val_nil();
  nr_v__app_post = val_nil();
  nr_v__app_put = val_nil();
  nr_v__app_delete = val_nil();
  nr_v__app_listen = val_nil();
  nr_v_path = val_nil();
  nr_v_handler = val_nil();
  nr_v_port = val_nil();
  nr_v___builtin_http_serve = val_nil();
  nr_v_http = val_nil();
  nr_v_print = val_nil();
  nr_v_start = val_nil();
  nr_v_end = val_nil();
  ...
  nr_v_app = val_func(nr_app);
  nr_v__app_get = val_func(nr__app_get);
  nr_v__app_post = val_func(nr__app_post);
  nr_v__app_put = val_func(nr__app_put);
  nr_v__app_delete = val_func(nr__app_delete);
  nr_v__app_listen = val_func(nr__app_listen);
  { Value _m = val_obj();
    set_field(_m, "app", val_func(nr_app));
    set_field(_m, "_app_get", val_func(nr__app_get));
    set_field(_m, "_app_post", val_func(nr__app_post));
    set_field(_m, "_app_put", val_func(nr__app_put));
    set_field(_m, "_app_delete", val_func(nr__app_delete));
    set_field(_m, "_app_listen", val_func(nr__app_listen));
    nr_v_http = _m; }
;
val_nil();
({ nr_rt_print(val_nil(), val_str("HTTP module loaded"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_app = ({ Value _f = get_field(nr_v_http, "app"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_http, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : nr_app(nr_v_http, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); });
({ nr_rt_print(val_nil(), val_str("App created"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
