...
;
val_nil();
({ nr_rt_print(val_nil(), ({ Value _f = nr_v_max; _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), val_int(10), val_int(20), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = nr_v_min; _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), val_int(10), val_int(20), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
