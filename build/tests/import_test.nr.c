...
int main(int argc, char** argv) {
  ...
  { Value _m = val_obj();
    ...
    nr_v_max = get_field(_m, "max");     nr_v_min = get_field(_m, "min");   }
;
val_nil();
({ nr_rt_print(val_nil(), nr_max(val_nil(), val_int(10), val_int(20), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_min(val_nil(), val_int(10), val_int(20), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
