...
Value nira_sqlite3_open(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nira_sqlite3_close(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nira_sqlite3_exec(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nira_sqlite3_query(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_open(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
...
Value nr_exec(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_query(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_close(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
...
Value nr_v_nira_sqlite3_open;
Value nr_v_nira_sqlite3_close;
Value nr_v_nira_sqlite3_exec;
Value nr_v_nira_sqlite3_query;
Value nr_v_open;
Value nr_v_path;
Value nr_v_conn;
Value nr_v_nil;
...
Value nr_open(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  nr_v_conn = nira_sqlite3_open(val_nil(), nr_v_path, val_nil(), val_nil(), val_nil(), val_nil());
  if (((nr_v_conn).data.i == (val_nil()).data.i)) {
  return val_nil();
  };
  return ({ Value _o = val_obj(); set_field(_o, "_conn", nr_v_conn); set_field(_o, "exec", val_func(nr_anon_1)); set_field(_o, "query", val_func(nr_anon_2)); set_field(_o, "close", val_func(nr_anon_3)); _o; });
  return val_nil();
}
Value nr_anon_1(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_sql;
  nr_v_sql = _v0; if(nr_v_sql.type == VAL_NIL) { }
  Value nr_v_params;
  nr_v_params = _v1; if(nr_v_params.type == VAL_NIL) { nr_v_params = ({ Value _a = val_arr(); _a; }); }
  return nira_sqlite3_exec(val_nil(), nr_v_conn, nr_v_sql, ({ Value _l = nr_v_params; IS_TRUTHY(_l) ? _l : ({ Value _a = val_arr(); _a; }); }), val_nil(), val_nil());
  return val_nil();
}
Value nr_anon_2(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  Value nr_v_params;
  nr_v_params = _v1; if(nr_v_params.type == VAL_NIL) { nr_v_params = ({ Value _a = val_arr(); _a; }); }
  return nira_sqlite3_query(val_nil(), nr_v_conn, nr_v_sql, ({ Value _l = nr_v_params; IS_TRUTHY(_l) ? _l : ({ Value _a = val_arr(); _a; }); }), val_nil(), val_nil());
  return val_nil();
}
Value nr_anon_3(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  return nira_sqlite3_close(val_nil(), nr_v_conn, val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_exec(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_conn;
  nr_v_conn = _v0; if(nr_v_conn.type == VAL_NIL) { }
  Value nr_v_sql;
  nr_v_sql = _v1; if(nr_v_sql.type == VAL_NIL) { }
  Value nr_v_params;
  nr_v_params = _v2; if(nr_v_params.type == VAL_NIL) { nr_v_params = ({ Value _a = val_arr(); _a; }); }
  return nira_sqlite3_exec(val_nil(), nr_v_conn, nr_v_sql, ({ Value _l = nr_v_params; IS_TRUTHY(_l) ? _l : ({ Value _a = val_arr(); _a; }); }), val_nil(), val_nil());
  return val_nil();
}
Value nr_query(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
...
int main(int argc, char** argv) {
  ...
  nr_v_nira_sqlite3_open = val_nil();
  nr_v_nira_sqlite3_close = val_nil();
  nr_v_nira_sqlite3_exec = val_nil();
  nr_v_nira_sqlite3_query = val_nil();
  nr_v_open = val_nil();
  nr_v_path = val_nil();
  nr_v_conn = val_nil();
  nr_v_nil = val_nil();
  ...
  nr_v_nira_sqlite3_open = val_func(nira_sqlite3_open);
  nr_v_nira_sqlite3_close = val_func(nira_sqlite3_close);
  nr_v_nira_sqlite3_exec = val_func(nira_sqlite3_exec);
  nr_v_nira_sqlite3_query = val_func(nira_sqlite3_query);
  nr_v_open = val_func(nr_open);
  nr_v_anon_1 = val_func(nr_anon_1);
  nr_v_anon_2 = val_func(nr_anon_2);
  nr_v_anon_3 = val_func(nr_anon_3);
  nr_v_exec = val_func(nr_exec);
  nr_v_query = val_func(nr_query);
  nr_v_close = val_func(nr_close);
  { Value _m = val_obj();
    set_field(_m, "nira_sqlite3_open", val_func(nira_sqlite3_open));
    set_field(_m, "nira_sqlite3_close", val_func(nira_sqlite3_close));
    set_field(_m, "nira_sqlite3_exec", val_func(nira_sqlite3_exec));
    set_field(_m, "nira_sqlite3_query", val_func(nira_sqlite3_query));
    set_field(_m, "open", val_func(nr_open));
    set_field(_m, "exec", val_func(nr_exec));
    set_field(_m, "query", val_func(nr_query));
    set_field(_m, "close", val_func(nr_close));
    nr_v_db = _m; }
;
  nr_v__db = ({ Value _f = get_field(nr_v_db, "open"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_db, val_str("tasks.db"), val_nil(), val_nil(), val_nil(), val_nil()) : nr_open(nr_v_db, val_str("tasks.db"), val_nil(), val_nil(), val_nil(), val_nil()); });
({ nr_rt_print(val_nil(), val_str("DB instance:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_v__db, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_items = ({ Value _f = get_field(nr_v__db, "query"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v__db, val_str("SELECT * FROM tasks"), val_nil(), val_nil(), val_nil(), val_nil()) : nr_query(nr_v__db, val_str("SELECT * FROM tasks"), val_nil(), val_nil(), val_nil(), val_nil()); });
  { Value _iter = nr_v_items; if (_iter.type == VAL_ARR) {
    for (int _i = 0; _i < _iter.data.arr->count; _i++) {
      nr_v_t = *_iter.data.arr->elements[_i];
({ nr_rt_print(val_nil(), val_str("Keys for task: "), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_ks = nr_rt_obj_keys(val_nil(), nr_v_t, val_nil(), val_nil(), val_nil(), val_nil());
  { Value _iter = nr_v_ks; if (_iter.type == VAL_ARR) {
    for (int _i = 0; _i < _iter.data.arr->count; _i++) {
      nr_v_k = *_iter.data.arr->elements[_i];
({ nr_rt_print(val_nil(), nr_rt_add(val_str("key: "), nr_v_k), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(nr_rt_add(nr_v_k, val_str(": ")), nr_rt_at(val_nil(), nr_v_t, nr_v_k, val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
    }
  } }
;
    }
