...
Value nr_greet(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_msg = _v0; if(nr_v_msg.type == VAL_NIL) { }
...
Value nr_createUser(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_age = _v1; if(nr_v_age.type == VAL_NIL) { }
  return ({ Value _o = val_obj(); set_field(_o, "name", nr_v_name); set_field(_o, "age", nr_v_age); set_field(_o, "getName", val_func(nr_getName)); set_field(_o, "greet", val_func(nr_greet)); set_field(_o, "getInfo", val_func(nr_anonymous)); _o; });
  return val_nil();
}
...
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u1, "getName"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (1) { nr_getName(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u2, "getName"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (1) { nr_getName(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u1, "greet"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u1, val_str("Hi"), val_nil(), val_nil(), val_nil(), val_nil()); } else if (1) { nr_greet(nr_v_u1, val_str("Hi"), val_nil(), val_nil(), val_nil(), val_nil()); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u2, "greet"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u2, val_str("Hello"), val_nil(), val_nil(), val_nil(), val_nil()); } else if (1) { nr_greet(nr_v_u2, val_str("Hello"), val_nil(), val_nil(), val_nil(), val_nil()); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("--- Testing Closure / getInfo ---"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u1, "getInfo"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u2, "getInfo"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
