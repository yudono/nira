...
Value nr_createUser(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_anon_1(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);

Value nr_v_getName;
Value nr_v_greet;
Value nr_v_msg;
Value nr_v_createUser;
Value nr_v_name;
Value nr_v_age;
Value nr_v_anon_1;
Value nr_v_print;
...
Value nr_getName(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  return nr_rt_at(val_nil(), self, val_str("name"), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_greet(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_msg;
  nr_v_msg = _v0; if(nr_v_msg.type == VAL_NIL) { }
  return nr_rt_add(nr_rt_add(nr_v_msg, val_str(" ")), nr_rt_at(val_nil(), self, val_str("name"), val_nil(), val_nil(), val_nil()));
  return val_nil();
}
Value nr_createUser(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  Value nr_v_age;
  nr_v_age = _v1; if(nr_v_age.type == VAL_NIL) { }
  return ({ Value _o = val_obj(); set_field(_o, "name", nr_v_name); set_field(_o, "age", nr_v_age); set_field(_o, "getName", val_func(nr_getName)); set_field(_o, "greet", val_func(nr_greet)); set_field(_o, "getInfo", val_func(nr_anon_1)); _o; });
  return val_nil();
}
Value nr_anon_1(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  return nr_rt_add(nr_rt_add(nr_rt_at(val_nil(), self, val_str("name"), val_nil(), val_nil(), val_nil()), val_str(" is ")), nr_rt_at(val_nil(), self, val_str("age"), val_nil(), val_nil(), val_nil()));
  return val_nil();
}
int main(int argc, char** argv) {
  ...
  nr_v_createUser = val_func(nr_createUser);
  nr_v_anon_1 = val_func(nr_anon_1);
val_func(nr_getName);
val_func(nr_greet);
val_func(nr_createUser);
val_nil();
({ nr_rt_print(val_nil(), val_str("--- Testing Method Sharing ---"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_u1 = nr_createUser(val_nil(), val_str("Budi"), val_int(25), val_nil(), val_nil(), val_nil());
  nr_v_u2 = nr_createUser(val_nil(), val_str("Ani"), val_int(22), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u1, "getName"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : nr_getName(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u2, "getName"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : nr_getName(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u1, "greet"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u1, val_str("Hi"), val_nil(), val_nil(), val_nil(), val_nil()) : nr_greet(nr_v_u1, val_str("Hi"), val_nil(), val_nil(), val_nil(), val_nil()); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u2, "greet"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u2, val_str("Hello"), val_nil(), val_nil(), val_nil(), val_nil()) : nr_greet(nr_v_u2, val_str("Hello"), val_nil(), val_nil(), val_nil(), val_nil()); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("--- Testing Closure / getInfo ---"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u1, "getInfo"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u2, "getInfo"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : val_nil(); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("--- Testing Mutation ---"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_rt_set_at(val_nil(), nr_v_u1, val_str("name"), val_str("Budi Santoso"), val_nil(), val_nil());
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u1, "getName"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : nr_getName(nr_v_u1, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_u2, "getName"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()) : nr_getName(nr_v_u2, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("--- OOP tests completed ---"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
