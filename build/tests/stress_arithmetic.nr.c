...
Value nr_factorial(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_fib_iter(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_power(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_harmonic_sum(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);

Value nr_v_factorial;
Value nr_v_n;
Value nr_v_fib_iter;
Value nr_v_a;
Value nr_v_b;
...
Value nr_factorial(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  if (((nr_v_n).data.i <= 1LL)) {
  return val_int(1);
  };
  return val_int(((nr_v_n).data.i * (nr_factorial(val_nil(), val_int(((nr_v_n).data.i - 1LL)), val_nil(), val_nil(), val_nil(), val_nil())).data.i));
  return val_nil();
}
Value nr_fib_iter(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  nr_v_temp = nr_rt_add(nr_v_a, nr_v_b);
  nr_v_a = nr_v_b;
  nr_v_b = nr_v_temp;
  nr_v_i = (nr_v_i + 1LL);
  }
...
Value nr_power(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_base;
  nr_v_base = _v0; if(nr_v_base.type == VAL_NIL) { }
  Value nr_v_exp;
  nr_v_exp = _v1; if(nr_v_exp.type == VAL_NIL) { }
  nr_v_result = val_int(1);
  nr_v_i = 0LL;
  while ((nr_v_i < (nr_v_exp).data.i)) {
  nr_v_result = val_int(((nr_v_result).data.i * (nr_v_base).data.i));
  nr_v_i = (nr_v_i + 1LL);
  }
;
  return nr_v_result;
...
Value nr_harmonic_sum(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_n;
  nr_v_n = _v0; if(nr_v_n.type == VAL_NIL) { }
  nr_v_total = val_float(0);
  nr_v_i = 1LL;
  while ((nr_v_i <= (nr_v_n).data.i)) {
  nr_v_total = nr_rt_add(nr_v_total, val_int(((val_float(1)).data.i / nr_v_i)));
  nr_v_i = (nr_v_i + 1LL);
  }
;
  return nr_v_total;
...
int main(int argc, char** argv) {
  ...
  nr_v_factorial = val_nil();
  nr_v_n = val_nil();
  nr_v_fib_iter = val_nil();
  nr_v_a = val_nil();
  nr_v_b = val_nil();
  nr_v_i = 0;
  nr_v_temp = val_nil();
  ...
  nr_v_factorial = val_func(nr_factorial);
  nr_v_fib_iter = val_func(nr_fib_iter);
  nr_v_power = val_func(nr_power);
  nr_v_harmonic_sum = val_func(nr_harmonic_sum);
val_func(nr_factorial);
val_func(nr_fib_iter);
val_func(nr_power);
val_func(nr_harmonic_sum);
val_nil();
({ nr_rt_print(val_nil(), val_str("=== STRESS: Arithmetic ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Factorial Tests:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("5! = "), nr_factorial(val_nil(), val_int(5), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("10! = "), nr_factorial(val_nil(), val_int(10), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("15! = "), nr_factorial(val_nil(), val_int(15), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("20! = "), nr_factorial(val_nil(), val_int(20), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Fibonacci Stress:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("fib(10) = "), nr_fib_iter(val_nil(), val_int(10), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("fib(20) = "), nr_fib_iter(val_nil(), val_int(20), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("fib(30) = "), nr_fib_iter(val_nil(), val_int(30), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("fib(40) = "), nr_fib_iter(val_nil(), val_int(40), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Power Tests:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("2^10 = "), nr_power(val_nil(), val_int(2), val_int(10), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("2^20 = "), nr_power(val_nil(), val_int(2), val_int(20), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("2^30 = "), nr_power(val_nil(), val_int(2), val_int(30), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("3^15 = "), nr_power(val_nil(), val_int(3), val_int(15), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Large Multiply Chain:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_val = val_int(1);
  nr_v_i = 1LL;
  while ((nr_v_i <= 25LL)) {
  nr_v_val = val_int(((nr_v_val).data.i * nr_v_i));
  nr_v_i = (nr_v_i + 1LL);
  }
;
({ nr_rt_print(val_nil(), nr_rt_add(val_str("25! = "), nr_v_val), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Float Precision Tests:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_a = nr_rt_add(val_float(0.1), val_float(0.2));
({ nr_rt_print(val_nil(), nr_rt_add(val_str("0.1 + 0.2 = "), nr_v_a), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_b = val_int(((val_float(1)).data.i / (val_float(3)).data.i));
({ nr_rt_print(val_nil(), nr_rt_add(val_str("1/3 = "), nr_v_b), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_c = nr_harmonic_sum(val_nil(), val_int(100), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Harmonic(100) = "), nr_v_c), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Negative Arithmetic:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("-5 * -3 = "), val_int(((0LL - 5LL) * (0LL - 3LL)))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("-100 + 50 = "), nr_rt_add(val_int((0LL - 100LL)), val_int(50))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("10 - 100 = "), val_int((10LL - 100LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("=== Arithmetic stress PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
