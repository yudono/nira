...
Value nr_factorial(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  return val_int((nr_v_n * (nr_factorial(val_nil(), val_int((nr_v_n - 1LL)), val_nil(), val_nil(), val_nil(), val_nil())).data.i));
  return val_nil();
}
Value nr_fib_iter(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
...
Value nr_power(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_base = _v0; if(nr_v_base.type == VAL_NIL) { }
  Value nr_v_exp = _v1; if(nr_v_exp.type == VAL_NIL) { }
