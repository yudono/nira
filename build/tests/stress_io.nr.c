...
Value nr_read(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_write(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_remove(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_append(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_exists(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_copy(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_move(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);

Value nr_v_read;
Value nr_v_path;
Value nr_v___builtin_file_read;
Value nr_v_write;
Value nr_v_content;
Value nr_v___builtin_file_write;
Value nr_v_remove;
Value nr_v___builtin_file_delete;
Value nr_v_append;
Value nr_v_existing;
Value nr_v_exists;
Value nr_v___builtin_file_exists;
Value nr_v_copy;
Value nr_v_src;
Value nr_v_dest;
Value nr_v_data;
...
Value nr_v_print;
long long nr_v_i;
Value nr_v_big_content;
long long nr_v_j;
Value nr_v_read_back;
Value nr_v_len;
Value nr_v_k;
Value nr_v_appended;
Value nr_v_m;
...
Value nr_read(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_path;
  nr_v_path = _v0; if(nr_v_path.type == VAL_NIL) { }
  return nr_rt_file_read(val_nil(), nr_v_path, val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_write(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  nr_v_path = _v0; if(nr_v_path.type == VAL_NIL) { }
  Value nr_v_content;
  nr_v_content = _v1; if(nr_v_content.type == VAL_NIL) { }
  return nr_rt_file_write(val_nil(), nr_v_path, nr_v_content, val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_remove(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_path;
  nr_v_path = _v0; if(nr_v_path.type == VAL_NIL) { }
  return nr_rt_file_delete(val_nil(), nr_v_path, val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_append(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  Value nr_v_content;
  nr_v_content = _v1; if(nr_v_content.type == VAL_NIL) { }
  nr_v_existing = nr_rt_file_read(val_nil(), nr_v_path, val_nil(), val_nil(), val_nil(), val_nil());
  return nr_rt_file_write(val_nil(), nr_v_path, nr_rt_add(nr_v_existing, nr_v_content), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_exists(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_path;
  nr_v_path = _v0; if(nr_v_path.type == VAL_NIL) { }
  return nr_rt_file_exists(val_nil(), nr_v_path, val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_copy(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_src;
  nr_v_src = _v0; if(nr_v_src.type == VAL_NIL) { }
  Value nr_v_dest;
  nr_v_dest = _v1; if(nr_v_dest.type == VAL_NIL) { }
  nr_v_data = nr_rt_file_read(val_nil(), nr_v_src, val_nil(), val_nil(), val_nil(), val_nil());
  return nr_rt_file_write(val_nil(), nr_v_dest, nr_v_data, val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_move(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  nr_v_dest = _v1; if(nr_v_dest.type == VAL_NIL) { }
  nr_v_data = nr_rt_file_read(val_nil(), nr_v_src, val_nil(), val_nil(), val_nil(), val_nil());
nr_rt_file_write(val_nil(), nr_v_dest, nr_v_data, val_nil(), val_nil(), val_nil());
  return nr_rt_file_delete(val_nil(), nr_v_src, val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
int main(int argc, char** argv) {
  ...
  nr_v_read = val_nil();
  nr_v_path = val_nil();
  nr_v___builtin_file_read = val_nil();
  nr_v_write = val_nil();
  nr_v_content = val_nil();
  nr_v___builtin_file_write = val_nil();
  nr_v_remove = val_nil();
  nr_v___builtin_file_delete = val_nil();
  nr_v_append = val_nil();
  nr_v_existing = val_nil();
  nr_v_exists = val_nil();
  nr_v___builtin_file_exists = val_nil();
  nr_v_copy = val_nil();
  nr_v_src = val_nil();
  nr_v_dest = val_nil();
  nr_v_data = val_nil();
  ...
  nr_v_print = val_nil();
  nr_v_i = 0;
  nr_v_big_content = val_nil();
  nr_v_j = 0;
  nr_v_read_back = val_nil();
  nr_v_len = val_nil();
  nr_v_k = val_nil();
  nr_v_appended = val_nil();
  nr_v_m = val_nil();
  nr_v_n = val_nil();
  nr_v_c = val_nil();
  nr_v_p = val_nil();
  ...
  nr_v_read = val_func(nr_read);
  nr_v_write = val_func(nr_write);
  nr_v_remove = val_func(nr_remove);
  nr_v_append = val_func(nr_append);
  nr_v_exists = val_func(nr_exists);
  nr_v_copy = val_func(nr_copy);
  nr_v_move = val_func(nr_move);
  { Value _m = val_obj();
    set_field(_m, "read", val_func(nr_read));
    set_field(_m, "write", val_func(nr_write));
    set_field(_m, "remove", val_func(nr_remove));
    set_field(_m, "append", val_func(nr_append));
    set_field(_m, "exists", val_func(nr_exists));
    set_field(_m, "copy", val_func(nr_copy));
    set_field(_m, "move", val_func(nr_move));
    nr_v_write = get_field(_m, "write");     nr_v_read = get_field(_m, "read");     nr_v_remove = get_field(_m, "remove");     nr_v_exists = get_field(_m, "exists");     nr_v_append = get_field(_m, "append");   }
;
val_nil();
...
nr_write(val_nil(), val_str("_test_io.txt"), val_str("Hello Nira!"), val_nil(), val_nil(), val_nil());
  nr_v_content = nr_read(val_nil(), val_str("_test_io.txt"), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Read: "), nr_v_content), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_remove(val_nil(), val_str("_test_io.txt"), val_nil(), val_nil(), val_nil(), val_nil());
...
({ nr_rt_print(val_nil(), val_str("Write/Read Cycles (100x):"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_i = 0LL;
  while ((nr_v_i < 100LL)) {
nr_write(val_nil(), val_str("_test_cycle.txt"), nr_rt_add(val_str("iteration_"), val_int(nr_v_i)), val_nil(), val_nil(), val_nil());
  nr_v_data = nr_read(val_nil(), val_str("_test_cycle.txt"), val_nil(), val_nil(), val_nil(), val_nil());
  if ((nr_v_i == 0LL)) {
({ nr_rt_print(val_nil(), nr_rt_add(val_str("First read: "), nr_v_data), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
  if ((nr_v_i == 99LL)) {
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Last read: "), nr_v_data), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
  nr_v_i = (nr_v_i + 1LL);
  }
;
nr_remove(val_nil(), val_str("_test_cycle.txt"), val_nil(), val_nil(), val_nil(), val_nil());
...
({ nr_rt_print(val_nil(), val_str("Large Content Write:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_big_content = val_str("");
  nr_v_j = 0LL;
  while ((nr_v_j < 500LL)) {
  nr_v_big_content = nr_rt_add(nr_rt_add(nr_rt_add(nr_v_big_content, val_str("Line ")), val_int(nr_v_j)), val_str(": This is test data for stress testing file I/O operations.\n"));
  nr_v_j = (nr_v_j + 1LL);
  }
;
nr_write(val_nil(), val_str("_test_large.txt"), nr_v_big_content, val_nil(), val_nil(), val_nil());
  nr_v_read_back = nr_read(val_nil(), val_str("_test_large.txt"), val_nil(), val_nil(), val_nil(), val_nil());
...
nr_remove(val_nil(), val_str("_test_large.txt"), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Append Test:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_write(val_nil(), val_str("_test_append.txt"), val_str("Line 1\n"), val_nil(), val_nil(), val_nil());
  nr_v_k = val_int(2);
  while (((nr_v_k).data.i <= 50LL)) {
nr_append(val_nil(), val_str("_test_append.txt"), nr_rt_add(nr_rt_add(val_str("Line "), nr_v_k), val_str("\n")), val_nil(), val_nil(), val_nil());
  nr_v_k = nr_rt_add(nr_v_k, val_int(1));
  }
;
  nr_v_appended = nr_read(val_nil(), val_str("_test_append.txt"), val_nil(), val_nil(), val_nil(), val_nil());
...
nr_remove(val_nil(), val_str("_test_append.txt"), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Multiple Files:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_m = val_int(0);
  while (((nr_v_m).data.i < 10LL)) {
nr_write(val_nil(), nr_rt_add(nr_rt_add(val_str("_test_multi_"), nr_v_m), val_str(".txt")), nr_rt_add(val_str("Content of file "), nr_v_m), val_nil(), val_nil(), val_nil());
  nr_v_m = nr_rt_add(nr_v_m, val_int(1));
  }
;
  nr_v_n = val_int(0);
  while (((nr_v_n).data.i < 10LL)) {
  nr_v_c = nr_read(val_nil(), nr_rt_add(nr_rt_add(val_str("_test_multi_"), nr_v_n), val_str(".txt")), val_nil(), val_nil(), val_nil(), val_nil());
...
nr_remove(val_nil(), nr_rt_add(nr_rt_add(val_str("_test_multi_"), nr_v_p), val_str(".txt")), val_nil(), val_nil(), val_nil(), val_nil());
...
nr_write(val_nil(), val_str("_test_exists.txt"), val_str("check"), val_nil(), val_nil(), val_nil());
  nr_v_ex = nr_exists(val_nil(), val_str("_test_exists.txt"), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("exists (before remove): "), nr_v_ex), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_remove(val_nil(), val_str("_test_exists.txt"), val_nil(), val_nil(), val_nil(), val_nil());
  nr_v_ex2 = nr_exists(val_nil(), val_str("_test_exists.txt"), val_nil(), val_nil(), val_nil(), val_nil());
...
nr_write(val_nil(), val_str("_test_overwrite.txt"), val_str("original"), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Before: "), nr_read(val_nil(), val_str("_test_overwrite.txt"), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_write(val_nil(), val_str("_test_overwrite.txt"), val_str("overwritten"), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("After: "), nr_read(val_nil(), val_str("_test_overwrite.txt"), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_remove(val_nil(), val_str("_test_overwrite.txt"), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Empty File Test:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_write(val_nil(), val_str("_test_empty.txt"), val_str(""), val_nil(), val_nil(), val_nil());
  nr_v_empty_content = nr_read(val_nil(), val_str("_test_empty.txt"), val_nil(), val_nil(), val_nil(), val_nil());
...
nr_remove(val_nil(), val_str("_test_empty.txt"), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
