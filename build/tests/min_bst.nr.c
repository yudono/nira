...
Value nr_create_node(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_insert(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_search(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_inorder(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);

Value nr_v_create_node;
Value nr_v_val;
Value nr_v_insert;
Value nr_v_root;
Value nr_v_search;
...
Value nr_create_node(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_val;
  nr_v_val = _v0; if(nr_v_val.type == VAL_NIL) { }
  return ({ Value _o = val_obj(); set_field(_o, "val", nr_v_val); set_field(_o, "left", val_nil()); set_field(_o, "right", val_nil()); _o; });
  return val_nil();
}
Value nr_insert(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_root;
  nr_v_root = _v0; if(nr_v_root.type == VAL_NIL) { }
  Value nr_v_val;
  nr_v_val = _v1; if(nr_v_val.type == VAL_NIL) { }
  if (((nr_v_root).data.i == (val_nil()).data.i)) {
  return nr_create_node(val_nil(), nr_v_val, val_nil(), val_nil(), val_nil(), val_nil());
  };
  if (((nr_v_val).data.i < (nr_rt_at(val_nil(), nr_v_root, val_str("val"), val_nil(), val_nil(), val_nil())).data.i)) {
  nr_rt_set_at(val_nil(), nr_v_root, val_str("left"), nr_insert(val_nil(), nr_rt_at(val_nil(), nr_v_root, val_str("left"), val_nil(), val_nil(), val_nil()), nr_v_val, val_nil(), val_nil(), val_nil()), val_nil(), val_nil());
  } else {
  nr_rt_set_at(val_nil(), nr_v_root, val_str("right"), nr_insert(val_nil(), nr_rt_at(val_nil(), nr_v_root, val_str("right"), val_nil(), val_nil(), val_nil()), nr_v_val, val_nil(), val_nil(), val_nil()), val_nil(), val_nil());
  }
;
  return nr_v_root;
  return val_nil();
...
Value nr_search(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  if (((nr_rt_at(val_nil(), nr_v_root, val_str("val"), val_nil(), val_nil(), val_nil())).data.i == (nr_v_val).data.i)) {
  return val_bool(true);
  };
  if (((nr_v_val).data.i < (nr_rt_at(val_nil(), nr_v_root, val_str("val"), val_nil(), val_nil(), val_nil())).data.i)) {
  return nr_search(val_nil(), nr_rt_at(val_nil(), nr_v_root, val_str("left"), val_nil(), val_nil(), val_nil()), nr_v_val, val_nil(), val_nil(), val_nil());
  } else {
  return nr_search(val_nil(), nr_rt_at(val_nil(), nr_v_root, val_str("right"), val_nil(), val_nil(), val_nil()), nr_v_val, val_nil(), val_nil(), val_nil());
  }
;
  return val_nil();
}
...
nr_inorder(val_nil(), nr_rt_at(val_nil(), nr_v_root, val_str("left"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Node: "), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_root, val_str("val"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_inorder(val_nil(), nr_rt_at(val_nil(), nr_v_root, val_str("right"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
int main(int argc, char** argv) {
  ...
  nr_v_create_node = val_nil();
  nr_v_val = val_nil();
  nr_v_insert = val_nil();
  nr_v_root = val_nil();
  nr_v_search = val_nil();
  nr_v_inorder = val_nil();
  nr_v_print = val_nil();
  ...
  nr_v_create_node = val_func(nr_create_node);
  nr_v_insert = val_func(nr_insert);
  nr_v_search = val_func(nr_search);
  nr_v_inorder = val_func(nr_inorder);
val_func(nr_create_node);
val_func(nr_insert);
val_func(nr_search);
val_func(nr_inorder);
val_nil();
({ nr_rt_print(val_nil(), val_str("=== MIN BST TEST ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_root = val_nil();
  nr_v_values = ({ Value _a = val_arr(); nr_rt_push(val_nil(), _a, val_int(50), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_int(30), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_int(20), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_int(40), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_int(70), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_int(60), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_int(80), val_nil(), val_nil(), val_nil()); _a; });
({ nr_rt_print(val_nil(), val_str("Inserting values..."), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  { Value _iter = nr_v_values; if (_iter.type == VAL_ARR) {
    for (int _i = 0; _i < _iter.data.arr->count; _i++) {
      nr_v_v = *_iter.data.arr->elements[_i];
  nr_v_root = nr_insert(val_nil(), nr_v_root, nr_v_v, val_nil(), val_nil(), val_nil());
    }
  } }
;
({ nr_rt_print(val_nil(), val_str("Inorder traversal:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_inorder(val_nil(), nr_v_root, val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str("Search Tests:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Search 40: "), nr_rt_to_string(val_nil(), nr_search(val_nil(), nr_v_root, val_int(40), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Search 90: "), nr_rt_to_string(val_nil(), nr_search(val_nil(), nr_v_root, val_int(90), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Search 20: "), nr_rt_to_string(val_nil(), nr_search(val_nil(), nr_v_root, val_int(20), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("=== MIN BST TEST PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
