...
Value nr_insert(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  if (((nr_v_val).data.i < (nr_rt_at(nr_v_root, val_str("val"))).data.i)) {
  nr_rt_set_at(nr_v_root, val_str("left"), nr_insert(val_nil(), nr_rt_at(nr_v_root, val_str("left")), nr_v_val, val_nil(), val_nil(), val_nil()));
  } else {
  nr_rt_set_at(nr_v_root, val_str("right"), nr_insert(val_nil(), nr_rt_at(nr_v_root, val_str("right")), nr_v_val, val_nil(), val_nil(), val_nil()));
  }
;
  return nr_v_root;
  return val_nil();
...
Value nr_search(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  if (((nr_rt_at(nr_v_root, val_str("val"))).data.i == (nr_v_val).data.i)) {
  return val_bool(true);
  };
  if (((nr_v_val).data.i < (nr_rt_at(nr_v_root, val_str("val"))).data.i)) {
  return nr_search(val_nil(), nr_rt_at(nr_v_root, val_str("left")), nr_v_val, val_nil(), val_nil(), val_nil());
  } else {
  return nr_search(val_nil(), nr_rt_at(nr_v_root, val_str("right")), nr_v_val, val_nil(), val_nil(), val_nil());
  }
;
  return val_nil();
}
...
nr_inorder(val_nil(), nr_rt_at(nr_v_root, val_str("left")), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(nr_rt_add(val_str("Node: "), nr_rt_to_string(nr_rt_at(nr_v_root, val_str("val"))))); val_nil(); });
nr_inorder(val_nil(), nr_rt_at(nr_v_root, val_str("right")), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
...
;
;
({ nr_rt_print(val_str("=== MIN BST TEST ===")); val_nil(); });
  nr_v_root = val_nil();
  nr_v_values = ({ Value _a = val_arr(); nr_rt_push(_a, val_int(50)); nr_rt_push(_a, val_int(30)); nr_rt_push(_a, val_int(20)); nr_rt_push(_a, val_int(40)); nr_rt_push(_a, val_int(70)); nr_rt_push(_a, val_int(60)); nr_rt_push(_a, val_int(80)); _a; });
({ nr_rt_print(val_str("Inserting values...")); val_nil(); });
...
;
({ nr_rt_print(val_str("Inorder traversal:")); val_nil(); });
nr_inorder(val_nil(), nr_v_root, val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_str("Search Tests:")); val_nil(); });
({ nr_rt_print(nr_rt_add(val_str("Search 40: "), nr_rt_to_string(nr_search(val_nil(), nr_v_root, val_int(40), val_nil(), val_nil(), val_nil())))); val_nil(); });
({ nr_rt_print(nr_rt_add(val_str("Search 90: "), nr_rt_to_string(nr_search(val_nil(), nr_v_root, val_int(90), val_nil(), val_nil(), val_nil())))); val_nil(); });
({ nr_rt_print(nr_rt_add(val_str("Search 20: "), nr_rt_to_string(nr_search(val_nil(), nr_v_root, val_int(20), val_nil(), val_nil(), val_nil())))); val_nil(); });
({ nr_rt_print(val_str("=== MIN BST TEST PASSED ===")); val_nil(); });
  return 0; 
}
