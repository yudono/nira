...
Value nr_v_hello;
Value nr_v_tabbed;
Value nr_v_backslash;
Value nr_v_quoted;
Value nr_v_mixed;
Value nr_v_multi;
Value nr_v_multi_with_code;
Value nr_v_prefix;
Value nr_v_name;
Value nr_v_lines;
Value nr_v_empty;
...
int main(int argc, char** argv) {
  ...
  nr_v_hello = val_nil();
  nr_v_tabbed = val_nil();
  nr_v_backslash = val_nil();
  nr_v_quoted = val_nil();
  nr_v_mixed = val_nil();
  nr_v_multi = val_nil();
  nr_v_multi_with_code = val_nil();
  nr_v_prefix = val_nil();
  nr_v_name = val_nil();
  nr_v_lines = val_nil();
  nr_v_empty = val_nil();
  nr_v_single = val_nil();
  nr_v_long_str = val_nil();
...
val_nil();
({ nr_rt_print(val_nil(), val_str("=== STRESS: String Features ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Escape Sequences:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_hello = val_str("Hello\nWorld");
({ nr_rt_print(val_nil(), nr_v_hello, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_tabbed = val_str("Col1	Col2	Col3");
({ nr_rt_print(val_nil(), nr_v_tabbed, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_backslash = val_str("path\to\file");
({ nr_rt_print(val_nil(), nr_v_backslash, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_quoted = val_str("She said \"hello\"");
({ nr_rt_print(val_nil(), nr_v_quoted, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_mixed = val_str("Line1\nLine2\n	Indented");
...
({ nr_rt_print(val_nil(), val_str("Multi-line Strings:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_multi = val_str("This is\n  a multi-line\n  string");
({ nr_rt_print(val_nil(), nr_v_multi, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_multi_with_code = val_str("function main:\n  x = 10\n  print(x)");
({ nr_rt_print(val_nil(), nr_v_multi_with_code, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Escape + Concat:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_prefix = val_str("Name:	");
  nr_v_name = val_str("Budi");
({ nr_rt_print(val_nil(), nr_rt_add(nr_v_prefix, nr_v_name), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_lines = val_str("A\nB\nC");
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Lines: "), nr_v_lines), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Edge Cases:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_empty = val_str("");
({ nr_rt_print(val_nil(), nr_rt_add(val_str("empty len: "), nr_rt_len(val_nil(), nr_v_empty, val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_single = val_str("x");
({ nr_rt_print(val_nil(), nr_rt_add(val_str("single: "), nr_v_single), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("String + Number Coercion:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_result = nr_rt_add(nr_rt_add(val_str("Score: "), val_int(42)), val_str("\nGrade: A"));
({ nr_rt_print(val_nil(), nr_v_result, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Long Escaped String:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_long_str = val_str("Row1	A	B	C\nRow2	D	E	F\nRow3	G	H	I");
({ nr_rt_print(val_nil(), nr_v_long_str, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("=== String Features PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
