...
val_nil();
({ nr_rt_print(val_nil(), val_str("Testing Arena Allocator..."), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_a = ({ Value _o = val_obj(); set_field(_o, "x", val_int(10)); set_field(_o, "y", val_int(20)); _o; });
({ nr_rt_print(val_nil(), nr_rt_at(val_nil(), nr_v_a, val_str("x"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_at(val_nil(), nr_v_a, val_str("y"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_arr_count = 0;
  { Value _iter = nr_v_arr; if (_iter.type == VAL_ARR) {
...
;
({ nr_rt_print(val_nil(), val_str("Arena test passed if no crash!"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
