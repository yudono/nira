...
Value nr_test_logic(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_test_while(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_test_null_error(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
...
Value nr_v_m;
Value nr_v_test_logic;
Value nr_v_print;
Value nr_v_test_while;
long long nr_v_i;
Value nr_v_test_null_error;
Value nr_v_val;
Value nr_v_res;
Value nr_v_start;
Value nr_v_end;
...
Value nr_test_logic(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
({ nr_rt_print(val_nil(), val_str("Logic Test:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_a = val_bool(true);
  nr_v_b = val_bool(false);
  if (((nr_v_a).data.i && (!(nr_v_b).data.i))) {
({ nr_rt_print(val_nil(), val_str("a and not b is true"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  } else {
({ nr_rt_print(val_nil(), val_str("logic failed"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  }
;
  if (((nr_v_b).data.i || (nr_v_a).data.i)) {
({ nr_rt_print(val_nil(), val_str("b or a is true"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
  return val_nil();
}
Value nr_test_while(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
({ nr_rt_print(val_nil(), val_str("While Test:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_i = 0LL;
  while ((nr_v_i < 10LL)) {
  nr_v_i = (nr_v_i + 1LL);
  if ((nr_v_i == 5LL)) {
...
({ nr_rt_print(val_nil(), val_int(nr_v_i), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  }
;
({ nr_rt_print(val_nil(), val_str("done while"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
Value nr_test_null_error(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
({ nr_rt_print(val_nil(), val_str("Null/Error Test:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_val = val_nil();
  if (((nr_v_val).data.i == (val_nil()).data.i)) {
({ nr_rt_print(val_nil(), val_str("val is null"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
  nr_v_res = val_error("Error");
({ nr_rt_print(val_nil(), nr_v_res, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
int main(int argc, char** argv) {
  ...
  nr_v_m = val_nil();
  nr_v_test_logic = val_nil();
  nr_v_print = val_nil();
  nr_v_test_while = val_nil();
  nr_v_i = 0;
  nr_v_test_null_error = val_nil();
  nr_v_val = val_nil();
  nr_v_res = val_nil();
  nr_v_start = val_nil();
  nr_v_end = val_nil();
  ...
  nr_v_test_logic = val_func(nr_test_logic);
  nr_v_test_while = val_func(nr_test_while);
  nr_v_test_null_error = val_func(nr_test_null_error);
  { Value _m = val_obj();
    ...
    nr_v_m = _m; }
;
val_func(nr_test_logic);
val_func(nr_test_while);
val_func(nr_test_null_error);
val_nil();
nr_test_logic(val_nil(), val_nil(), val_nil(), val_nil(), val_nil(), val_nil());
nr_test_while(val_nil(), val_nil(), val_nil(), val_nil(), val_nil(), val_nil());
nr_test_null_error(val_nil(), val_nil(), val_nil(), val_nil(), val_nil(), val_nil());
  if ((val_bool(true)).data.i) {
  /* pass */;
  } else {
({ nr_rt_print(val_nil(), val_str("never"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  }
;
  return 0; 
}
