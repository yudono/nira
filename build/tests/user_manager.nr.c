...
Value nr_create_user(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_data = _v0; if(nr_v_data.type == VAL_NIL) { }
  return ({ Value _o = val_obj(); set_field(_o, "id", nr_rt_at(val_nil(), nr_v_data, val_str("id"), val_nil(), val_nil(), val_nil())); set_field(_o, "name", nr_rt_at(val_nil(), nr_v_data, val_str("name"), val_nil(), val_nil(), val_nil())); set_field(_o, "role", val_int(((nr_rt_at(val_nil(), nr_v_data, val_str("role"), val_nil(), val_nil(), val_nil())).data.i || (val_str("user")).data.i))); set_field(_o, "status", val_str("active")); _o; });
  return val_nil();
}
Value nr_update_status(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_user = _v0; if(nr_v_user.type == VAL_NIL) { }
  Value nr_v_new_status = _v1; if(nr_v_new_status.type == VAL_NIL) { }
