...
Value nr_create_user(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_update_status(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_print_user(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);

Value nr_v_create_user;
Value nr_v_data;
Value nr_v_update_status;
Value nr_v_user;
Value nr_v_new_status;
Value nr_v_print_user;
Value nr_v_print;
Value nr_v_toString;
Value nr_v_user1;
Value nr_v_user2;
...
Value nr_create_user(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  return ({ Value _o = val_obj(); set_field(_o, "id", nr_rt_at(val_nil(), nr_v_data, val_str("id"), val_nil(), val_nil(), val_nil())); set_field(_o, "name", nr_rt_at(val_nil(), nr_v_data, val_str("name"), val_nil(), val_nil(), val_nil())); set_field(_o, "role", ({ Value _l = nr_rt_at(val_nil(), nr_v_data, val_str("role"), val_nil(), val_nil(), val_nil()); IS_TRUTHY(_l) ? _l : val_str("user"); })); set_field(_o, "status", val_str("active")); _o; });
  return val_nil();
}
Value nr_update_status(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_user;
  nr_v_user = _v0; if(nr_v_user.type == VAL_NIL) { }
  Value nr_v_new_status;
  nr_v_new_status = _v1; if(nr_v_new_status.type == VAL_NIL) { }
  nr_rt_set_at(val_nil(), nr_v_user, val_str("status"), nr_v_new_status, val_nil(), val_nil());
  return nr_v_user;
  return val_nil();
}
Value nr_print_user(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_user;
  nr_v_user = _v0; if(nr_v_user.type == VAL_NIL) { }
({ nr_rt_print(val_nil(), nr_rt_add(nr_rt_add(nr_rt_add(nr_rt_add(nr_rt_add(nr_rt_add(nr_rt_add(val_str("User ["), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_user, val_str("id"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_str("]: ")), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_user, val_str("name"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_str(" (")), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_user, val_str("role"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_str(") - ")), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_user, val_str("status"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
int main(int argc, char** argv) {
  ...
  nr_v_create_user = val_nil();
  nr_v_data = val_nil();
  nr_v_update_status = val_nil();
  nr_v_user = val_nil();
  nr_v_new_status = val_nil();
  nr_v_print_user = val_nil();
  nr_v_print = val_nil();
  ...
  nr_v_create_user = val_func(nr_create_user);
  nr_v_update_status = val_func(nr_update_status);
  nr_v_print_user = val_func(nr_print_user);
val_func(nr_create_user);
val_func(nr_update_status);
val_func(nr_print_user);
val_nil();
({ nr_rt_print(val_nil(), val_str("=== USER MANAGER TEST ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_user1 = nr_create_user(val_nil(), ({ Value _o = val_obj(); set_field(_o, "id", val_int(1)); set_field(_o, "name", val_str("Budi")); set_field(_o, "role", val_str("admin")); _o; }), val_nil(), val_nil(), val_nil(), val_nil());
  nr_v_user2 = nr_create_user(val_nil(), ({ Value _o = val_obj(); set_field(_o, "id", val_int(2)); set_field(_o, "name", val_str("Ani")); _o; }), val_nil(), val_nil(), val_nil(), val_nil());
nr_print_user(val_nil(), nr_v_user1, val_nil(), val_nil(), val_nil(), val_nil());
nr_print_user(val_nil(), nr_v_user2, val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str("Updating Ani's status..."), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
nr_update_status(val_nil(), nr_v_user2, val_str("suspended"), val_nil(), val_nil(), val_nil());
nr_print_user(val_nil(), nr_v_user2, val_nil(), val_nil(), val_nil(), val_nil());
  nr_v_users = ({ Value _a = val_arr(); nr_rt_push(val_nil(), _a, nr_v_user1, val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, nr_v_user2, val_nil(), val_nil(), val_nil()); _a; });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Total users: "), nr_rt_to_string(val_nil(), nr_rt_len(val_nil(), nr_v_users, val_nil(), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  { Value _iter = nr_v_users; if (_iter.type == VAL_ARR) {
    for (int _i = 0; _i < _iter.data.arr->count; _i++) {
      nr_v_u = *_iter.data.arr->elements[_i];
  if (((nr_rt_at(val_nil(), nr_v_u, val_str("role"), val_nil(), val_nil(), val_nil())).data.i == (val_str("admin")).data.i)) {
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Admin found: "), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_u, val_str("name"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
    }
  } }
;
({ nr_rt_print(val_nil(), val_str("=== USER MANAGER TEST PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
