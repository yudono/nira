...
Value nr_create_employee(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_id;
  nr_v_id = _v0; if(nr_v_id.type == VAL_NIL) { }
  Value nr_v_name;
  nr_v_name = _v1; if(nr_v_name.type == VAL_NIL) { }
  Value nr_v_role;
  nr_v_role = _v2; if(nr_v_role.type == VAL_NIL) { }
...
Value nr_add_employee(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_dept;
  nr_v_dept = _v0; if(nr_v_dept.type == VAL_NIL) { }
  Value nr_v_emp;
  nr_v_emp = _v1; if(nr_v_emp.type == VAL_NIL) { }
  nr_v_emps = nr_rt_at(val_nil(), nr_v_dept, val_str("employees"), val_nil(), val_nil(), val_nil());
({ nr_rt_push(val_nil(), nr_v_emps, nr_v_emp, val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
Value nr_add_sub_dept(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  nr_v_dept = _v0; if(nr_v_dept.type == VAL_NIL) { }
  Value nr_v_sub;
  nr_v_sub = _v1; if(nr_v_sub.type == VAL_NIL) { }
  nr_v_subs = nr_rt_at(val_nil(), nr_v_dept, val_str("sub_departments"), val_nil(), val_nil(), val_nil());
({ nr_rt_push(val_nil(), nr_v_subs, nr_v_sub, val_nil(), val_nil(), val_nil()); val_nil(); });
  return val_nil();
}
Value nr_print_org(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
...
({ nr_rt_print(val_nil(), nr_rt_add(nr_rt_add(nr_v_indent, val_str("Department: ")), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_dept, val_str("name"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  { Value _iter = nr_rt_at(val_nil(), nr_v_dept, val_str("employees"), val_nil(), val_nil(), val_nil()); if (_iter.type == VAL_ARR) {
    for (int _i = 0; _i < _iter.data.arr->count; _i++) {
      nr_v_emp = *_iter.data.arr->elements[_i];
({ nr_rt_print(val_nil(), nr_rt_add(nr_rt_add(nr_rt_add(nr_rt_add(nr_rt_add(nr_v_indent, val_str("  - Employee: ")), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_emp, val_str("name"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_str(" (")), nr_rt_to_string(val_nil(), nr_rt_at(val_nil(), nr_v_emp, val_str("role"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil())), val_str(")")), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
    }
  } }
;
  { Value _iter = nr_rt_at(val_nil(), nr_v_dept, val_str("sub_departments"), val_nil(), val_nil(), val_nil()); if (_iter.type == VAL_ARR) {
    for (int _i = 0; _i < _iter.data.arr->count; _i++) {
...
int main(int argc, char** argv) {
  ...
  nr_v_create_employee = val_func(nr_create_employee);
  nr_v_create_department = val_func(nr_create_department);
  nr_v_add_employee = val_func(nr_add_employee);
  nr_v_add_sub_dept = val_func(nr_add_sub_dept);
  nr_v_print_org = val_func(nr_print_org);
val_func(nr_create_employee);
val_func(nr_create_department);
val_func(nr_add_employee);
val_func(nr_add_sub_dept);
val_func(nr_print_org);
val_nil();
({ nr_rt_print(val_nil(), val_str("=== COMPANY ORG TEST ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
...
({ nr_rt_print(val_nil(), val_str("=== ORG TEST PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
