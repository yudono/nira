...
({ nr_rt_print(val_nil(), nr_rt_add(val_str("true and true = "), ({ Value _l = val_bool(true); !IS_TRUTHY(_l) ? _l : val_bool(true); })), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("true and false = "), ({ Value _l = val_bool(true); !IS_TRUTHY(_l) ? _l : val_bool(false); })), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("false or true = "), ({ Value _l = val_bool(false); IS_TRUTHY(_l) ? _l : val_bool(true); })), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("false or false = "), ({ Value _l = val_bool(false); IS_TRUTHY(_l) ? _l : val_bool(false); })), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
