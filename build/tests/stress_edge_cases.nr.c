...
Value nr_v_b;
Value nr_v_c;
Value nr_v_empty_arr;
Value nr_v_empty_obj;
Value nr_v_err;
Value nr_v_x;
Value nr_v_y;
Value nr_v_z;
Value nr_v_empty_str;
Value nr_v_special;
Value nr_v_tab_str;
Value nr_v_emoji;
Value nr_v_jp;
...
Value nr_v_num;
Value nr_v_str_val;
Value nr_v_float_val;
Value nr_v_str_float;
Value nr_v_result2;
Value nr_v_result3;
Value nr_v_big;
Value nr_v_small;
int main(int argc, char** argv) {
  ...
  nr_v_b = val_nil();
  nr_v_c = val_nil();
  nr_v_empty_arr = val_nil();
  nr_v_empty_obj = val_nil();
  nr_v_err = val_nil();
  nr_v_x = val_nil();
  nr_v_y = val_nil();
  nr_v_z = val_nil();
  nr_v_empty_str = val_nil();
  nr_v_special = val_nil();
  nr_v_tab_str = val_nil();
  nr_v_emoji = val_nil();
  nr_v_jp = val_nil();
  nr_v_mixed = val_nil();
  nr_v_num = val_nil();
  nr_v_str_val = val_nil();
  nr_v_float_val = val_nil();
  nr_v_str_float = val_nil();
  nr_v_result2 = val_nil();
  nr_v_result3 = val_nil();
  nr_v_big = val_nil();
  nr_v_small = val_nil();
...
val_nil();
({ nr_rt_print(val_nil(), val_str("=== STRESS: Edge Cases ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Division by Zero: SKIPPED (causes expected halt)"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Null Handling:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_val = val_nil();
({ nr_rt_print(val_nil(), nr_rt_add(val_str("val = "), nr_v_val), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  if (((nr_v_val).data.i == (val_nil()).data.i)) {
({ nr_rt_print(val_nil(), val_str("val is null: true"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  } else {
({ nr_rt_print(val_nil(), val_str("val is null: false"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  }
;
  nr_v_a = val_nil();
  nr_v_b = val_nil();
  if (((nr_v_a).data.i == (nr_v_b).data.i)) {
({ nr_rt_print(val_nil(), val_str("null == null: true"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
  nr_v_c = val_nil();
  if (((nr_v_c).data.i != 1LL)) {
({ nr_rt_print(val_nil(), val_str("null != 1: true"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Empty Collections:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_empty_arr = ({ Value _a = val_arr(); _a; });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("empty array length: "), nr_rt_len(val_nil(), nr_v_empty_arr, val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_empty_obj = ({ Value _o = val_obj(); _o; });
({ nr_rt_print(val_nil(), val_str("empty object created"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_push(val_nil(), nr_v_empty_arr, val_int(42), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("after push, length: "), nr_rt_len(val_nil(), nr_v_empty_arr, val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("first element: "), nr_rt_at(val_nil(), nr_v_empty_arr, val_int(0), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Error Handling:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_err = ((Value){.type = VAL_ERROR, .data.s = "Error"});
({ nr_rt_print(val_nil(), nr_rt_add(val_str("error value: "), nr_v_err), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Boolean Edge Cases:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("true and true = "), val_int(((val_bool(true)).data.i && (val_bool(true)).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("true and false = "), val_int(((val_bool(true)).data.i && (val_bool(false)).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("false or true = "), val_int(((val_bool(false)).data.i || (val_bool(true)).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("false or false = "), val_int(((val_bool(false)).data.i || (val_bool(false)).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("not true = "), val_bool((!(val_bool(true)).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("not false = "), val_bool((!(val_bool(false)).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_x = val_bool(true);
  nr_v_y = val_bool(false);
  nr_v_z = val_bool(true);
  if ((((nr_v_x).data.i && (!(nr_v_y).data.i)) && (nr_v_z).data.i)) {
({ nr_rt_print(val_nil(), val_str("complex boolean: true"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  };
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("String Edge Cases:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_empty_str = val_str("");
({ nr_rt_print(val_nil(), nr_rt_add(val_str("empty string length: "), nr_rt_len(val_nil(), nr_v_empty_str, val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  { const char* _lit = ""; nr_v_s_len = strlen(_lit); memcpy(nr_v_s, _lit, nr_v_s_len); nr_v_s[nr_v_s_len] = 0; };
  nr_v_i = 0LL;
  while ((nr_v_i < 100LL)) {
nr_rt_add(val_str_len(nr_v_s, nr_v_s_len), val_str("x"));
  nr_v_i = (nr_v_i + 1LL);
  }
;
({ nr_rt_print(val_nil(), nr_rt_add(val_str("100 x's length: "), nr_rt_len(val_nil(), val_str_len(nr_v_s, nr_v_s_len), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_special = val_str("hello\nworld");
({ nr_rt_print(val_nil(), val_str("escaped newline:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_v_special, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_tab_str = val_str("col1	col2");
({ nr_rt_print(val_nil(), nr_rt_add(val_str("escaped tab: "), nr_v_tab_str), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Unicode Stress:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_emoji = val_str("Hello 🌍🚀");
({ nr_rt_print(val_nil(), nr_v_emoji, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_jp = val_str("日本語テスト");
({ nr_rt_print(val_nil(), nr_v_jp, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_mixed = val_str("abc 你好 🎉 end");
({ nr_rt_print(val_nil(), nr_v_mixed, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Type Coercion:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_num = val_int(42);
  nr_v_str_val = nr_rt_add(val_str("Number: "), nr_v_num);
({ nr_rt_print(val_nil(), nr_v_str_val, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_float_val = ((Value){.type = VAL_FLOAT, .data.f = 3.14});
  nr_v_str_float = nr_rt_add(val_str("Pi: "), nr_v_float_val);
({ nr_rt_print(val_nil(), nr_v_str_float, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Comparison Edge Cases:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("1 == 1: "), val_int((1LL == 1LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("1 != 2: "), val_int((1LL != 2LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("1 < 2: "), val_int((1LL < 2LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("2 > 1: "), val_int((2LL > 1LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("1 <= 1: "), val_int((1LL <= 1LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("1 >= 1: "), val_int((1LL >= 1LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("str eq: "), val_int(((val_str("abc")).data.i == (val_str("abc")).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("str neq: "), val_int(((val_str("abc")).data.i != (val_str("xyz")).data.i))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Modulo Tests:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("10 %% 3 = "), val_int((10LL % 3LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("7 %% 2 = "), val_int((7LL % 2LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("100 %% 10 = "), val_int((100LL % 10LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("17 %% 5 = "), val_int((17LL % 5LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Power Tests:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("2 ** 10 = "), val_int(pow(2LL, 10LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("3 ** 4 = "), val_int(pow(3LL, 4LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("5 ** 3 = "), val_int(pow(5LL, 3LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("10 ** 0 = "), val_int(pow(10LL, 0LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("2 ** 16 = "), val_int(pow(2LL, 16LL))), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Chained Operations:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_result2 = val_int(((2LL + 3LL) * (4LL + 5LL)));
({ nr_rt_print(val_nil(), nr_rt_add(val_str("(2+3) * (4+5) = "), nr_v_result2), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_result3 = val_int((((10LL - 3LL) - 2LL) - 1LL));
({ nr_rt_print(val_nil(), nr_rt_add(val_str("10 - 3 - 2 - 1 = "), nr_v_result3), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Boundary Values:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_big = val_int(2147483647);
({ nr_rt_print(val_nil(), nr_rt_add(val_str("MAX_INT32: "), nr_v_big), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_small = val_int((0LL - -2147483648LL));
({ nr_rt_print(val_nil(), nr_rt_add(val_str("MIN_INT32: "), nr_v_small), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("=== Edge Cases stress PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
