...
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_m, "max"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_m, val_int(5), val_int(1), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
...
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_user, "getName"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_user, val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_net = nr_v_m;
({ nr_rt_print(val_nil(), val_str("Standalone Alias Test:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), ({ Value _f = get_field(nr_v_net, "max"); if(_f.type==VAL_FUNC) { ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_net, val_int(100), val_int(200), val_nil(), val_nil(), val_nil()); } else if (0) { val_nil(); } else { val_nil(); } }), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
