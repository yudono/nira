...
int main(int argc, char** argv) {
  ...
  nr_v_bubble_sort = val_func(nr_bubble_sort);
  nr_v_linear_search = val_func(nr_linear_search);
  nr_v_reverse_arr = val_func(nr_reverse_arr);
  nr_v_contains = val_func(nr_contains);
