...
({ Value _f = get_field(nr_v_object, "assign"); _f.type==VAL_FUNC ? ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(nr_v_object, nr_v_user, nr_v_extra, val_nil(), val_nil(), val_nil()) : val_nil(); });
