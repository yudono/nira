...
int main(int argc, char** argv) {
  ...
  nr_v_department = ({ Value _o = val_obj(); set_field(_o, "name", val_str("Head Office")); set_field(_o, "sub_departments", ({ Value _a = val_arr(); nr_rt_push(val_nil(), _a, ({ Value _o = val_obj(); set_field(_o, "name", val_str("Sales")); set_field(_o, "staff", val_int(10)); _o; }), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, ({ Value _o = val_obj(); set_field(_o, "name", val_str("Engineering")); set_field(_o, "staff", val_int(50)); _o; }), val_nil(), val_nil(), val_nil()); _a; })); _o; });
  nr_v_head_office = nr_v_department;
({ nr_rt_print(val_nil(), nr_rt_at(val_nil(), nr_v_head_office, val_str("name"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_at(val_nil(), nr_rt_at(val_nil(), nr_v_head_office, val_str("sub_departments"), val_nil(), val_nil(), val_nil()), val_str("length"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_at(val_nil(), nr_rt_at(val_nil(), nr_rt_at(val_nil(), nr_v_head_office, val_str("sub_departments"), val_nil(), val_nil(), val_nil()), val_int(0), val_nil(), val_nil(), val_nil()), val_str("name"), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
