...
Value nr_ackermann(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_n = _v1; if(nr_v_n.type == VAL_NIL) { }
  if (((nr_v_m).data.i == 0LL)) {
  return nr_rt_add(val_int(nr_v_n), val_int(1));
  };
  if ((nr_v_n == 0LL)) {
  return nr_ackermann(val_nil(), val_int(((nr_v_m).data.i - 1LL)), val_int(1), val_nil(), val_nil(), val_nil());
  };
  return nr_ackermann(val_nil(), val_int(((nr_v_m).data.i - 1LL)), nr_ackermann(val_nil(), nr_v_m, val_int((nr_v_n - 1LL)), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_count_down(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  Value nr_v_n = _v0; if(nr_v_n.type == VAL_NIL) { }
  if ((nr_v_n <= 0LL)) {
  return val_int(0);
  };
  return nr_count_down(val_nil(), val_int((nr_v_n - 1LL)), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_recursive_sum(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  ...
  return nr_rt_add(val_int(nr_v_n), nr_recursive_sum(val_nil(), val_int((nr_v_n - 1LL)), val_nil(), val_nil(), val_nil(), val_nil()));
  return val_nil();
}
Value nr_is_even(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  ...
  return nr_is_odd(val_nil(), val_int((nr_v_n - 1LL)), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_is_odd(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0, nr_v_n=0;
  ...
  return nr_is_even(val_nil(), val_int((nr_v_n - 1LL)), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
