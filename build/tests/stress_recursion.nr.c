...
Value nr_ackermann(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_count_down(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_recursive_sum(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_is_even(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);
Value nr_is_odd(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4);

Value nr_v_ackermann;
Value nr_v_m;
Value nr_v_n;
Value nr_v_count_down;
Value nr_v_recursive_sum;
Value nr_v_is_even;
Value nr_v_is_odd;
Value nr_v_print;
Value nr_v_result;
...
Value nr_ackermann(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_n;
  nr_v_n = _v1; if(nr_v_n.type == VAL_NIL) { }
  if (((nr_v_m).data.i == 0LL)) {
  return nr_rt_add(nr_v_n, val_int(1));
  };
  if (((nr_v_n).data.i == 0LL)) {
  return nr_ackermann(val_nil(), val_int(((nr_v_m).data.i - 1LL)), val_int(1), val_nil(), val_nil(), val_nil());
  };
  return nr_ackermann(val_nil(), val_int(((nr_v_m).data.i - 1LL)), nr_ackermann(val_nil(), nr_v_m, val_int(((nr_v_n).data.i - 1LL)), val_nil(), val_nil(), val_nil()), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_count_down(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_n;
  nr_v_n = _v0; if(nr_v_n.type == VAL_NIL) { }
  if (((nr_v_n).data.i <= 0LL)) {
  return val_int(0);
  };
  return nr_count_down(val_nil(), val_int(((nr_v_n).data.i - 1LL)), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_recursive_sum(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  return nr_rt_add(nr_v_n, nr_recursive_sum(val_nil(), val_int(((nr_v_n).data.i - 1LL)), val_nil(), val_nil(), val_nil(), val_nil()));
  return val_nil();
}
Value nr_is_even(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  return nr_is_odd(val_nil(), val_int(((nr_v_n).data.i - 1LL)), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
Value nr_is_odd(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  ...
  return nr_is_even(val_nil(), val_int(((nr_v_n).data.i - 1LL)), val_nil(), val_nil(), val_nil(), val_nil());
  return val_nil();
}
int main(int argc, char** argv) {
  ...
  nr_v_ackermann = val_nil();
  nr_v_m = val_nil();
  nr_v_n = val_nil();
  nr_v_count_down = val_nil();
  nr_v_recursive_sum = val_nil();
  nr_v_is_even = val_nil();
  nr_v_is_odd = val_nil();
  nr_v_print = val_nil();
  nr_v_result = val_nil();
  ...
  nr_v_len = val_nil();
  nr_v_root = val_nil();
  nr_v_current = val_nil();
  nr_v_j = 0;
  nr_v_child = val_nil();
  nr_v_big_arr = val_nil();
  nr_v_k = val_nil();
  nr_v_start = val_nil();
  nr_v_end = val_nil();
  nr_v_sum = val_nil();
  ...
  nr_v_ackermann = val_func(nr_ackermann);
  nr_v_count_down = val_func(nr_count_down);
  nr_v_recursive_sum = val_func(nr_recursive_sum);
  nr_v_is_even = val_func(nr_is_even);
  nr_v_is_odd = val_func(nr_is_odd);
val_func(nr_ackermann);
val_func(nr_count_down);
val_func(nr_recursive_sum);
val_func(nr_is_even);
val_func(nr_is_odd);
val_nil();
({ nr_rt_print(val_nil(), val_str("=== STRESS: Recursion & Memory ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Ackermann Tests:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("A(0,0) = "), nr_ackermann(val_nil(), val_int(0), val_int(0), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("A(1,1) = "), nr_ackermann(val_nil(), val_int(1), val_int(1), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("A(2,2) = "), nr_ackermann(val_nil(), val_int(2), val_int(2), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("A(3,3) = "), nr_ackermann(val_nil(), val_int(3), val_int(3), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Deep Recursion:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_result = nr_count_down(val_nil(), val_int(100), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("count_down(100) = "), nr_v_result), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_result2 = nr_recursive_sum(val_nil(), val_int(100), val_nil(), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), nr_rt_add(val_str("recursive_sum(100) = "), nr_v_result2), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Mutual Recursion:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("is_even(10) = "), nr_is_even(val_nil(), val_int(10), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("is_odd(11) = "), nr_is_odd(val_nil(), val_int(11), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("is_even(7) = "), nr_is_even(val_nil(), val_int(7), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("is_odd(0) = "), nr_is_odd(val_nil(), val_int(0), val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Arena Allocation Stress:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_items = ({ Value _a = val_arr(); _a; });
  nr_v_i = 0LL;
  while ((nr_v_i < 1000LL)) {
({ nr_rt_push(val_nil(), nr_v_items, ({ Value _o = val_obj(); set_field(_o, "id", val_int(nr_v_i)); set_field(_o, "name", nr_rt_add(val_str("object_"), val_int(nr_v_i))); set_field(_o, "value", val_int((nr_v_i * 10LL))); _o; }), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_i = (nr_v_i + 1LL);
  }
;
({ nr_rt_print(val_nil(), val_str("Allocated 1000 objects"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("First: id="), nr_rt_at(val_nil(), nr_rt_at(val_nil(), nr_v_items, val_int(0), val_nil(), val_nil(), val_nil()), val_str("id"), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Last: id="), nr_rt_at(val_nil(), nr_rt_at(val_nil(), nr_v_items, val_int(999), val_nil(), val_nil(), val_nil()), val_str("id"), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("items length = "), nr_rt_len(val_nil(), nr_v_items, val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Nested Object Stress:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_root = ({ Value _o = val_obj(); set_field(_o, "level", val_int(0)); set_field(_o, "data", val_str("root")); _o; });
  nr_v_current = nr_v_root;
  nr_v_j = 1LL;
  while ((nr_v_j <= 20LL)) {
  nr_v_child = ({ Value _o = val_obj(); set_field(_o, "level", val_int(nr_v_j)); set_field(_o, "data", nr_rt_add(val_str("level_"), val_int(nr_v_j))); set_field(_o, "parent_level", nr_rt_at(val_nil(), nr_v_current, val_str("level"), val_nil(), val_nil(), val_nil())); _o; });
  nr_v_current = nr_v_child;
  nr_v_j = (nr_v_j + 1LL);
  }
;
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Deepest level: "), nr_rt_at(val_nil(), nr_v_current, val_str("level"), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Deepest data: "), nr_rt_at(val_nil(), nr_v_current, val_str("data"), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("Array Growth Stress:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_big_arr = ({ Value _a = val_arr(); _a; });
  nr_v_k = val_int(0);
  while (((nr_v_k).data.i < 2000LL)) {
({ nr_rt_push(val_nil(), nr_v_big_arr, nr_v_k, val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_k = nr_rt_add(nr_v_k, val_int(1));
  }
;
({ nr_rt_print(val_nil(), nr_rt_add(val_str("Array size: "), nr_rt_len(val_nil(), nr_v_big_arr, val_nil(), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("big_arr[0] = "), nr_rt_at(val_nil(), nr_v_big_arr, val_int(0), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_rt_add(val_str("big_arr[1999] = "), nr_rt_at(val_nil(), nr_v_big_arr, val_int(1999), val_nil(), val_nil(), val_nil())), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str(""), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("=== Recursion & Memory stress PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
