...
Value nr_format_val(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_indent;
  nr_v_indent = _v1; if(nr_v_indent.type == VAL_NIL) { }
  nr_v_t = nr_rt_typeof(val_nil(), nr_v_val, val_nil(), val_nil(), val_nil(), val_nil());
  ...
  return nr_rt_to_string(val_nil(), nr_v_val, val_nil(), val_nil(), val_nil(), val_nil());
  };
...
Value nr_format_array(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  long long nr_v_i=0, nr_v_j=0;
  Value nr_v_arr;
  nr_v_arr = _v0; if(nr_v_arr.type == VAL_NIL) { }
  Value nr_v_indent;
  nr_v_indent = _v1; if(nr_v_indent.type == VAL_NIL) { }
  if (((nr_rt_len(val_nil(), nr_v_arr, val_nil(), val_nil(), val_nil(), val_nil())).data.i == 0LL)) {
  return val_str("[]");
  };
  nr_v_res = val_str("[\n");
  nr_v_new_indent = nr_rt_add(nr_v_indent, val_str("  "));
  nr_v_i = 0LL;
  while ((nr_v_i < (nr_rt_len(val_nil(), nr_v_arr, val_nil(), val_nil(), val_nil(), val_nil())).data.i)) {
  nr_v_res = nr_rt_add(nr_rt_add(nr_v_res, nr_v_new_indent), nr_format_val(val_nil(), nr_rt_at(val_nil(), nr_v_arr, val_int(nr_v_i), val_nil(), val_nil(), val_nil()), nr_v_new_indent, val_nil(), val_nil(), val_nil()));
  if ((nr_v_i < ((nr_rt_len(val_nil(), nr_v_arr, val_nil(), val_nil(), val_nil(), val_nil())).data.i - 1LL))) {
...
Value nr_format_object(Value self, Value _v0, Value _v1, Value _v2, Value _v3, Value _v4) {
  ...
  Value nr_v_indent;
  nr_v_indent = _v1; if(nr_v_indent.type == VAL_NIL) { }
  nr_v_keys = nr_rt_obj_keys(val_nil(), nr_v_obj, val_nil(), val_nil(), val_nil(), val_nil());
  if (((nr_rt_len(val_nil(), nr_v_keys, val_nil(), val_nil(), val_nil(), val_nil())).data.i == 0LL)) {
  return val_str("{}");
  };
  nr_v_res = val_str("{\n");
  nr_v_new_indent = nr_rt_add(nr_v_indent, val_str("  "));
  nr_v_i = 0LL;
  while ((nr_v_i < (nr_rt_len(val_nil(), nr_v_keys, val_nil(), val_nil(), val_nil(), val_nil())).data.i)) {
  nr_v_k = nr_rt_at(val_nil(), nr_v_keys, val_int(nr_v_i), val_nil(), val_nil(), val_nil());
  nr_v_v = nr_rt_at(val_nil(), nr_v_obj, nr_v_k, val_nil(), val_nil(), val_nil());
  ...
  if ((nr_v_i < ((nr_rt_len(val_nil(), nr_v_keys, val_nil(), val_nil(), val_nil(), val_nil())).data.i - 1LL))) {
  nr_v_res = nr_rt_add(nr_v_res, val_str(","));
  };
  nr_v_res = nr_rt_add(nr_v_res, val_str("\n"));
  nr_v_i = (nr_v_i + 1LL);
...
int main(int argc, char** argv) {
  ...
  nr_v_format_val = val_func(nr_format_val);
  nr_v_format_array = val_func(nr_format_array);
  nr_v_format_object = val_func(nr_format_object);
val_func(nr_format_val);
val_func(nr_format_array);
val_func(nr_format_object);
val_nil();
({ nr_rt_print(val_nil(), val_str("=== MINI JSON ENGINE TEST ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  nr_v_complex_data = ({ Value _o = val_obj(); set_field(_o, "id", val_int(101)); set_field(_o, "title", val_str("Test Suite")); set_field(_o, "active", val_bool(true)); set_field(_o, "tags", ({ Value _a = val_arr(); nr_rt_push(val_nil(), _a, val_str("nira"), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_str("test"), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, val_str("complex"), val_nil(), val_nil(), val_nil()); _a; })); set_field(_o, "config", ({ Value _o = val_obj(); set_field(_o, "timeout", val_int(5000)); set_field(_o, "retries", val_int(3)); set_field(_o, "endpoints", ({ Value _a = val_arr(); nr_rt_push(val_nil(), _a, ({ Value _o = val_obj(); set_field(_o, "url", val_str("/api/v1")); set_field(_o, "method", val_str("GET")); _o; }), val_nil(), val_nil(), val_nil()); nr_rt_push(val_nil(), _a, ({ Value _o = val_obj(); set_field(_o, "url", val_str("/api/v2")); set_field(_o, "method", val_str("POST")); _o; }), val_nil(), val_nil(), val_nil()); _a; })); _o; })); set_field(_o, "metadata", val_nil()); _o; });
  nr_v_formatted = nr_format_val(val_nil(), nr_v_complex_data, val_str(""), val_nil(), val_nil(), val_nil());
({ nr_rt_print(val_nil(), val_str("Formatted Output:"), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), nr_v_formatted, val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
({ nr_rt_print(val_nil(), val_str("=== JSON ENGINE TEST PASSED ==="), val_nil(), val_nil(), val_nil(), val_nil()); val_nil(); });
  return 0; 
}
