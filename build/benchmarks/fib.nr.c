...
Value nr_fib(Value self, Value nr_v_a1, Value nr_v_a2, Value nr_v_a3, Value nr_v_a4, Value nr_v_a5) {
  ...
  if (is_truthy(val_int(nr_v_n.data.i < val_int(2).data.i))) {
  return nr_v_n;
  };
...
val_func(nr_fib);
;
  nr_v_start = (void)({ Value _f = nr_v_millis; Value _r; if (_f.type == VAL_FUNC && _f.data.func_ptr) _r = ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); else { nr_rt_print(val_error("Function not found: millis")); _r = val_nil(); } _r; });
  nr_v_result = nr_fib(val_nil(), val_int(35), val_nil(), val_nil(), val_nil(), val_nil());
  nr_v_end = (void)({ Value _f = nr_v_millis; Value _r; if (_f.type == VAL_FUNC && _f.data.func_ptr) _r = ((Value (*)(Value, Value, Value, Value, Value, Value))_f.data.func_ptr)(val_nil(), val_nil(), val_nil(), val_nil(), val_nil(), val_nil()); else { nr_rt_print(val_error("Function not found: millis")); _r = val_nil(); } _r; });
