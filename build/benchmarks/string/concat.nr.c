...
nr_rt_print(nr_rt_add(nr_rt_add(nr_rt_add(nr_rt_add(val_str("Nira: "), nr_rt_to_string(val_int((nr_v_end - nr_v_start)))), val_str(" ms (Length: ")), nr_rt_to_string(val_int(nr_v_s_len))), val_str(")")));
  return 0; 
}
